...
To install Simple DNSCrypt use the [latest MSI package](https://github.com/bitbeans/SimpleDnsCrypt/releases/download/0.3.4/SimpleDNSCrypt.msi).
...
The minisign [signature](https://github.com/bitbeans/SimpleDnsCrypt/releases/download/0.3.4/SimpleDNSCrypt.msi.minisig) can be verified with the following command:
