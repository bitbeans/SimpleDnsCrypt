...
To install Simple DNSCrypt use the [latest MSI package](https://github.com/bitbeans/SimpleDnsCrypt/releases/download/0.2.3-beta/SimpleDNSCrypt.msi).
...
The minisign [signature](https://github.com/bitbeans/SimpleDnsCrypt/releases/download/0.2.3-beta/SimpleDNSCrypt.msi.minisig) can be verified with the following command:
